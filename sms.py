    ...
    def stats(self):
        ...
        try:
            if self.counter[0] > 0 or self.counter[1] > 0:
                ...
                print "{0} scorpion strikes deferred. ({1} Failed)".format(self.counter[0], self.counter[1])
...
def usage():
	print 'Usage: scorpion (url)'
	print 'Example: scorpion.py http://luthi.co.il/'
	print "\a"
print \   
""" 
...
def main():
    ...
    try:
        ...
        scorpion = Scorpion(url)
        scorpion.useragents = useragents
        scorpion.nr_workers = workers
        scorpion.method = method
        scorpion.nr_sockets = socks
